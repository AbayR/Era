...
<body id="page-top">
        ...
        <div class="container"><a class="navbar-brand" href="#page-top">Aituhana</a><button data-toggle="collapse"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    <li class="nav-item"><a class="nav-link" href="#menuModal" data-toggle="modal">Menu</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="#reservationModal"
                            data-toggle="modal">Reservation</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">Contacts</a></li>
                    <li class="nav-item"><a class="nav-link" href="login.php">Log in</a></li>
                    <li class="nav-item"><a class="nav-link" href="registration.php">Sign in</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section id="contact" style="background-image: url('assets/img/contact-us-background.jpg');background-size: cover;">
        <div class="container">
                               ...
                               if(array_key_exists('message', $_POST))
                                {
                                    ...
                                    $phone = $_POST["phone_number_message"];
                                    $message = $_POST["text_message"];
                                    if($username !="" && $email !=""){
                                        
                                        $sql = "INSERT INTO message (user, email, phone_number, text_message) VALUES (?, ?, ?, ?)";
                                         
                                        if($stmt = mysqli_prepare($link, $sql)){
                                            // Bind variables to the prepared statement as parameters
                                            mysqli_stmt_bind_param($stmt, "ssss", $param_user, $param_email, $param_phone_number, $param_text_message);
                                            
                                            $param_user = $username; 
                                            $param_email = $email;
                                            $param_phone_number = $phone;
                                            $param_text_message = $message;
                                            
                                            // Attempt to execute the prepared statement
                                            if(mysqli_stmt_execute($stmt)){
                                                echo '<script language="javascript">';
                                                echo 'alert("Сообщение отправлено")';  //not showing an alert box.
                                                echo '</script>';
                                            $username = $email = $phone = $message = "";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action ="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="contactForm" name="contactForm" method = "post" >
                        <div class="form-row">
                            <div class="col col-md-6">
                                <div class="form-group"><input autocomplete = "off" class="form-control" type="text" name="name_message"
                                        placeholder="Ваше Имя *" required=""><small
                                        class="form-text text-danger flex-grow-1 help-block lead"></small></div>
                                <div class="form-group"><input autocomplete = "off" class="form-control" type="email" name="email_message"
                                        placeholder="Ваш Email *" required=""><small
                                        class="form-text text-danger help-block lead"></small></div>
                                <div class="form-group"><input autocomplete = "off" class="form-control" type="tel" name="phone_number_message"
                                        placeholder="Ваш номер телефона без + *" required="" onkeypress="return onlyNumberKey(event)" maxlength="11"><small
                                        class="form-text text-danger help-block lead"></small></div>
                                <div class="form-group"><small class="form-text text-danger help-block lead"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><textarea autocomplete = "off" class="form-control" name="text_message" id="message"
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div><button class="btn btn-primary btn-xl text-uppercase"
                                    id="test" name ="message" type="submit" >Send message</button>
                            ...
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Cooking with Love.</p><img
                                        class="img-fluid d-block mx-auto" src="assets/img/gallery/pasta.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Cooking with Love.</p><img
                                        class="img-fluid d-block mx-auto" src="assets/img/gallery/steak.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Cooking with Love.</p><img
                                        class="img-fluid d-block mx-auto" src="assets/img/gallery/fish.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Cooking with Love.</p><img
                                        class="img-fluid d-block mx-auto" src="assets/img/gallery/pizza.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Cooking with Love.</p><img
                                        class="img-fluid d-block mx-auto" src="assets/img/gallery/salad.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Cooking with Love.</p><img
                                        class="img-fluid d-block mx-auto" src="assets/img/gallery/soup.jpg">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-12 text-center"
                                                    ...
                                                    <h1 class="section-heading text-uppercase">Log in as a user to make a reservation.
                                                    </h1>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body" style="width: 837px;">
                                    <h2 class="text-uppercase" style="padding: 0px;padding-bottom: 40px;">Меню</h2>
